...
# License: MIT
#
# An open-source Model Context Protocol (MCP) server engineered for time-series 
# forecasting.
#
# Key Capabilities:
# 1. Predictive Modeling: Leverages Facebook's Prophet library to generate 
#    accurate forecasts and trend analysis directly within LLM workflows.
# 2. LLM-Friendly Output: Returns forecasts with rich, human-readable summaries
#    and raw data for further analysis.
#
# This server empowers developers and analysts to easily integrate advanced
# forecasting into their AI applications.
#
# Contributions are welcome. Please see the repository for usage and logic.
# =============================================================================
...
def health_check():
    ...
    return jsonify({"status": "healthy", "service": "prophet_mcp"}), 200
